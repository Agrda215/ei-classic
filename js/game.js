...
setInterval(() => {
    ...
    game.layers[0].gain = game.points.pow(new Decimal(1).times(game.layers[0].exponent)).div(game.layers[0].req).div(10).floor()
    ...
    document.getElementsByClassName("prestige")[0].innerHTML = "Reset +" + game.layers[0].gain + " Coins.<br>Next at " + game.points.pow(new Decimal(1).times(game.layers[0].exponent)).div(game.layers[0].req).div(10) + " Points."
